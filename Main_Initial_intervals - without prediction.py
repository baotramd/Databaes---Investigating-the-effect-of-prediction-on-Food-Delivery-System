...
if __name__ == '__main__':
    ...
    interval_num = 0 #current, so forecase num = interval num + 1
    ...
    df_CourierSample = pd.read_excel(os.path.join(sample_path, curr_sample), sheet_name="Initial Position")
    ...
    # No need to save the result for the first iteration
